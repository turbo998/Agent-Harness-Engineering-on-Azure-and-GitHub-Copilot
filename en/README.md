...
| File | Description |
|------|-------------|
| `README.md` (root) | Project README (Chinese) |
| `en/README.md` | Project README (English) |
| `en/docs/DESIGN.md` | Design Principles (English) |
| `docs/DESIGN.md` | Design Principles (Chinese) |
